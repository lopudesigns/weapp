  ...
  static SLIDER_CONTENTS = [
    {
      ...
      defaultTitle: 'Write and publish a post on Ezira',
    ...
    },
    {
      ...
      defaultTitle: 'Earn rewards in eCoin',
      className: 'HeroBannerSlider__image',
      number: 3,
    },
  ];
          ...
          <div className="HeroBanner__content-container">
            <div className="HeroBanner__content">
              <img
                ...
                alt="Write and publish a post on Ezira"
              />
              <div className="HeroBanner__content__description">
                ...
                <div className="HeroBanner__content__title">
                  <FormattedMessage
                    ...
                    defaultMessage="Write and publish a post on Ezira"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="HeroBanner__content__description">
                ...
                <div className="HeroBanner__content__title" style={{ width: '130px' }}>
                  <FormattedMessage
                    ...
                    defaultMessage="Earn rewards in eCoin"
                  />
                </div>
              </div>
            </div>
