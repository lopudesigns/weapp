...
import './ManifestFormAux.less';
import { Link } from 'react-router';

class ManifestFormAux extends React.Component {
  static propTypes = {
        ...
        <Form.Item hasFeedback>
          {getFieldDecorator('username', {
            rules: [
              ...
              { validator: wehelpjs.help.accountExist },
            ],
          })(
						<Input 
...
export default Form.create()(injectIntl(ManifestFormAux));
