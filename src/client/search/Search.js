...
import { searchAskNode } from './searchActions';
...
class Search extends React.Component {
  static propTypes = {
    ...
    searchAskNode: PropTypes.func.isRequired,
  };
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (oldSearchQuery !== newSearchQuery) {
      this.props.searchAskNode(newSearchQuery);
    }
  }
  ...
  render() {
    ...
    return (
      <div className="settings-layout container">
        <Helmet>
          <title>{intl.formatMessage({ id: 'search', defaultMessage: 'Search' })} Ezira</title>
        </Helmet>
