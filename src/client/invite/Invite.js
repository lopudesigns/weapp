          ...
          <div className="center">
            <div className="Invite">
              ...
              <p className="Invite__description">
                <FormattedMessage
                  id="invite_info"
                  defaultMessage="Onboard new users on steemit.weYouMe.io today using the link below and get 10% of their rewards for 30 days."
                />
              </p>
              ...
              <div className="Invite__social">
                ...
                <TwitterShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on steemit.weYouMe.io and get rewarded to blog {link}',
                    },
                    {
                      link: '',
                    },
